...
import Icon from '@/assets/icons/solaris-icon.svg'
import Image from "next/image";

export default function Footer() {
    return (
        <footer className={'bg-gray-900'}>
            <div className="py-4 md:py-6 w-100">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-1 justify-between items-center">
                            ...
                            {/* Copyrights note */}
                            <div className="text-gray-400 text-sm mr-4 flex gap-2 items-center">
                                <Image src={Icon} alt={""} />
                                &copy; Solaris.com. All rights reserved.
                            </div>
