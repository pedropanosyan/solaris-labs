                ...
                <div className="py-12 md:py-20">
                    ...
                    <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                        <h2 className="h2 mb-4">
                            Solaris delivers clarity, ensuring optimal solutions for your business needs.
                        </h2>
                        <p className="text-xl text-gray-400">
                            At the Forefront of Technology, Solaris Engineers Strive To Achieve Optimal Solutions For
                            Your Business. Empowering Efficiency And Driving Growth.<br/>
                        </p>
                        <div
                            className="inline-flex text-sm font-semibold py-1 px-3 mt-5 text-green-600 bg-green-200 rounded-full">
                    ...
                    <div
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up"
                            ...
                            <p className="text-lg text-gray-400 text-center">
                                Collaboration is key to our process. We work closely with you to understand your
                                requirements, provide regular updates, and incorporate your feedback every step of the
                                way.
                            </p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100"
                            ...
                            <h4 className="h4 mb-2">Execute at lightning speed</h4>
                            <p className="text-lg text-gray-400 text-center">
                                We embrace Agile methodologies to propel your projects forward at lightning speed,
                                ensuring rapid development cycles and responsiveness to your needs.
                            </p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200"
                            ...
                            <h4 className="h4 mb-2">Customized Process</h4>
                            <p className="text-lg text-gray-400 text-center">
                                Unlock the potential of custom software development with our expert team. We specialize
                                in crafting innovative solutions tailored to meet your unique needs.
                            </p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300"
                            ...
                            <h4 className="h4 mb-2">Cutting-edge Technologies</h4>
                            <p className="text-lg text-gray-400 text-center">
                                Our team is dedicated to continuously adapt in this rapidly evolving world. We
                                leverage the latest advancements to transform your business.
                            </p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400"
                            ...
                            <h4 className="h4 mb-2">Scalability Solutions</h4>
                            <p className="text-lg text-gray-400 text-center">
                                Grow your business with ease using our scalable solutions. Adapt and expand your
                                technology as your business evolves.
                            </p>
                        </div>
                        ...
                        <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500"
                            ...
                            <h4 className="h4 mb-2">Quality Assurance</h4>
                            <p className="text-lg text-gray-400 text-center">
                                Quality is at the heart of everything we do. We ensure that every
                                product meets the highest standards of performance, reliability, and security.
                            </p>
                        </div>
